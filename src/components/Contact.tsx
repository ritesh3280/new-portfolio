    ...
    <section id="contact" className="py-20 bg-white dark:bg-black transition-colors duration-300">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-12 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-4">Let's connect and collaborate</p>
        </div>

        {/* Main card */}
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12 hover:border-red-500 transition-all duration-300 hover:shadow-md">
          <p className="text-center text-gray-700 dark:text-gray-300 text-base md:text-lg mb-10 max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <a
              href={`mailto:${email}`}
              className="group bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6 hover:border-red-500 hover:bg-red-50 dark:hover:bg-gray-700 transition-all duration-300 hover:shadow-sm"
            >
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-red-100 dark:bg-red-900/30 rounded-full flex items-center justify-center border border-red-200 dark:border-red-800 group-hover:bg-red-200 dark:group-hover:bg-red-900/50 transition-all duration-300">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-gray-900 dark:text-white font-medium truncate">{email}</p>
                </div>
              </div>
            </a>
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Devpost</p>
                  <p className="text-gray-900 dark:text-white font-medium">See my projects</p>
                </div>
              </div>
            </a>
          </div>
